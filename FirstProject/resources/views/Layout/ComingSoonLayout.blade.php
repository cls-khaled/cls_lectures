...
<head>
    ...
    <link rel="stylesheet"  href="{{URL::asset('ComingStyle/css/base.css')}}">
    <link rel="stylesheet"  href="{{URL::asset('ComingStyle/css/vendor.css')}}">
    <link rel="stylesheet"  href="{{URL::asset('ComingStyle/css/main.css')}}">
    ...
    <script src="{{URL::asset('ComingStyle/js/modernizr.js')}}"></script>
    <script src="{{URL::asset('ComingStyle/js/pace.min.js')}}"></script>
...
<body>
    ...
    <script src="{{URL::asset('ComingStyle/js/jquery-3.2.1.min.js')}}"></script>
    <script src="{{URL::asset('ComingStyle/js/plugins.js')}}"></script>
    <script src="{{URL::asset('ComingStyle/js/main.js')}}"></script>
