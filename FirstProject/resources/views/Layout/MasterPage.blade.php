...
<html lang="en">
  ...
  <head>
   ...
   <!-- <link rel="stylesheet" href="public/bootstrap/css/bootstrap.min.css"> -->
    ...
    <!-- assets/css/fontawesome.css --><!-- Additional CSS Files -->
    <link rel="stylesheet"  href="{{URL::asset('css/fontawesome.css')}}">
    <link rel="stylesheet"  href="{{URL::asset('css/templatemo-villa-agency.css')}}">
